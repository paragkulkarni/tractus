...
const Contract = () => {
  ...
  const handleSubmit = (event) => {
    ...
    axios.post(`${URL}/post`, formObject).then((res) => {
      if (res.status === 200) {
        handleClose();
      } else {
        event.preventDefault();
      ...
      <div>
        <div className="row">
          <div>
            ...
            <Button variant="outline-primary" onClick={createContract}>
              Create Contract
            </Button>
          </div>
        </div>
            ...
            <div>
              <Form validated={validated} onSubmit={handleSubmit}>
                ...
                <Form.Group>
                  ...
                  <Form.Control
                    name="contract_aggreement"
                    required
                    type="text"
                    value={formField.contract_aggreement}
                    onChange={handleChange}
                  />
                </Form.Group>
                <Form.Group>
                  ...
                  <Form.Control
                    ...
                    type="text"
                    required
                    value={formField.contract_owner}
                    onChange={handleChange}
                  />
                </Form.Group>
                <Form.Group>
                  ...
                  <Form.Select
                    ...
                    onChange={handleChange}
                  >
                    <option value="start" defaultValue>
                      Start
                    </option>
                  </Form.Select>
                </Form.Group>
