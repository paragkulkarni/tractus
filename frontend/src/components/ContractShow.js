  ...
  return (
    <>
      <Card
        ...
        text={
          (details.status == "start" ? "info" : "success") === "light"
            ? "dark"
            : "white"
        }
        className="mb-2"
      >
        ...
        <Card.Body>
          ...
          <Card.Text>Agreement : {details.agreement}</Card.Text>
          <Card.Text>Status : {details.status}</Card.Text>
